    ...
    function getSepoliaEthConfig() public pure returns (NetworkConfig memory) {
        return
            NetworkConfig({
                ...
                subscriptionId: 60927450627634785021142353298031235092617327873158803062436978216609168794436,
                link: 0x779877A7B0D9E8603169DdbD7836e478b4624789,
                account: 0x0002995778df3034F43Be58844a6C0f74ae00081
            });
    }

    function getOrCreateAnvilEthConfig() public returns (NetworkConfig memory) {
        // cheak to see if we set an active network config
